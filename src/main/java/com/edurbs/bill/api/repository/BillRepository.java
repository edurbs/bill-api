...
public interface BillRepository extends JpaRepository<Bill, Long> {
    @Query("SELECT b FROM Bill b WHERE (:description is null or b."+Bill_.DESCRIPTION+" LIKE %:description%) " 
            + "and (:fromDueDate is null or b."+Bill_.DUE_DATE+" >= :fromDueDate) "
            + "and (:toDueDate is null or b."+Bill_.DUE_DATE+" <= :toDueDate)")            
